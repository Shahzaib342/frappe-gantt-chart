...
class Gantt {
    ...
    setup_options(options) {
        const default_options = {
            ...
            bar_height: 20,
            bar_corner_radius: 10, //changed from 3 to 10
            arrow_curve: 5,
            padding: 18,
            view_mode: 'Day',
    ...
    setup_gantt_dates() {
        ...
        if(this.view_is(VIEW_MODE.MONTH)) {
            ...
            this.gantt_end = date_utils.add(this.gantt_end, 4, 'month');
        }
    ...
    bind_bar_events() {
        ...
        $.on(this.$svg, 'mousedown', '.bar-wrapper, .handle', (e, element) => {
            ...
            if (element.classList.contains('left')) {
                is_resizing_left = false; // changed true to false
            } else if (element.classList.contains('right')) {
                is_resizing_right = false; // changed true to false
            } else if (element.classList.contains('bar-wrapper')) {
                is_dragging = false; // changed true to false
            }
